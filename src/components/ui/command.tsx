...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      style={{ borderRadius: 6, padding: "6px 10px", cursor: "pointer", fontSize: 12, color: "#0f172a" }}
      className={cn(
        "data-[selected=true]:bg-blue-50 data-[selected=true]:text-blue-700 relative flex items-center gap-2 outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50",
        className
      )}
      {...props}
    />
